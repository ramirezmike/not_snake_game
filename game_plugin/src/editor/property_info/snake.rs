...
pub struct SnakePropertyInfo {
    color: PropertyWrapper<Color>,
}

pub struct SnakePropertyHandler;
impl PropertyInfoHandler for SnakePropertyHandler {
    type T = SnakePropertyInfo;
    ...
    fn handle_item_selection(
        entity: Entity,
        mut prop: &mut ResMut<SnakePropertyInfo>,
