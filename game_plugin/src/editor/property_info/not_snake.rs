...
pub struct NotSnakePropertyInfo {
    color: PropertyWrapper<Color>,
}

pub struct NotSnakePropertyHandler;
impl PropertyInfoHandler for NotSnakePropertyHandler {
    type T = NotSnakePropertyInfo;
    ...
    fn handle_item_selection(
        entity: Entity,
        mut prop: &mut ResMut<NotSnakePropertyInfo>,
