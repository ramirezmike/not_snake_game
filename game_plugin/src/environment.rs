...
use crate::{
    block, camera, camera::MainCamera, collectable, credits, dude, dust, food, game_controller,
    holdable, level, level::Level, level_over, moveable, path_find, path_find::PathFinder, score,
    snake, sounds, teleporter, win_flag, EntityType, GameObject, Position,
};
        ...
        app.insert_resource(Level::new())
            ...
            .add_system_set(
                SystemSet::on_enter(crate::AppState::InGame)
                    ...
                    .with_system(
                        level_over::setup_level_over_screen
                            .system()
                            .after("loading_level"),
                    ),
            )
            ...
            .add_system_set(
                SystemSet::on_update(crate::AppState::InGame)
                    ...
                    .with_system(dust::animate_dust.system()), //.with_system(snake::debug_trigger_snake_death.system())
            );
...
pub fn pause_game(
    ...
    if keyboard_input.just_pressed(KeyCode::Escape)
        || pressed_buttons.contains(&game_controller::GameButton::Start)
    {
