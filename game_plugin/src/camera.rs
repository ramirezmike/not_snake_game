use crate::{dude, environment, level::Level};
...
impl Plugin for CameraPlugin {
    fn build(&self, app: &mut App) {
        app.add_system_set(
            SystemSet::on_update(crate::AppState::InGame), //.with_system(toggle_fly.system())
        )
        .add_system_set(
        ...
        .add_system_set(
            SystemSet::on_update(crate::AppState::MainMenu), //.with_system(toggle_fly.system())
        )
